...
function antonova_product_price_icon($index) {
    $icons = array(
        ...
        '<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M10 35c3 12 14 20 27 20s24-8 27-20c-8 3-15 3-22 0-6-3-12-3-19 0-5 2-9 2-13 0zM10 35c4-12 14-20 26-20 10 0 19 6 24 16M16 29c6-5 13-7 20-5 7 2 12 6 18 7M22 23c4 4 7 9 9 15M33 18c3 5 5 11 5 17M44 21c-1 6-4 12-8 16"/></svg>',
        ...
        '<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 18c-10 0-17 6-15 16 2 12 8 21 15 26 7-5 13-14 15-26 2-10-5-16-15-16zM32 18c-5-6-10-7-15-5M32 18c3-7 9-8 15-6M27 14l-3-6M37 13l4-5M17 36c5-3 9 2 15 2s10-5 15-2M19 44c4-3 8 2 13 2s9-5 13-2M25 28h.01M33 26h.01M40 30h.01M25 39h.01M35 41h.01"/></svg>',
